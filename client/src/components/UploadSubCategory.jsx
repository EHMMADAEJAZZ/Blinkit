...
const UploadSubCategory = ({ closeModel,fetchSubCategory }) => {
  ...
  const handleCategory = async (e) => {
    ...
    try {
      ...
      const data = await subcategoryApis.addSubCategory(formData);
  ...
  return (
    <section className=' max-w-lg w-full bg-white'>
      <Model onCloseModel={closeModel} className='min-w-[400px] max-w-lg max-h-[550px] p-2 sm:p-5 overflow-hidden overflow-y-scroll'>
        <div className="py-4">
