  ...
  return (
    <div className='container mx-auto px-4 my-5 relative'>
      <div className='flex items-center justify-between '>
        <h2 className='text-sm sm:text-lg md:text-xl font-semibold capitalize'>
          {categoryName}
        </h2>
        <Link to={redirect} className='text-green-600 capitalize'>
          see All
        </Link>
      </div>
      <div
        className='w-full flex items-center  gap-2 sm:gap-4 lg:gap-8 overflow-hidden
          overflow-x-scroll mt-2 scroll-smooth '
        ref={refContainer}
      >
        ...
        <div className='hidden w-full absolute md:flex justify-between p-2 '>
          <button
            onClick={scrollLeft}
            className=' rounded-full bg-white shadow-2xl z-30 border border-gray-500/30 text-center p-1 hover:bg-yellow-300/80 hover:scale-110 transition-all duration-300'
          >
