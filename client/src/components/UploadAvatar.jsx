      ...
      <Model onCloseModel={onClose}>
        ...
        <div className='w-full'>
          <form onSubmit={handleAvatar} className='w-full flex flex-col gap-4'>
            <label
              htmlFor='avatar'
              className='w-fit min-w-20  mt-1 text-sm bg-gray-200 border rounded-full border-primary-100 hover:border-primary-200 block p-1 hover:bg-neutral-700 hover:text-white'
            >
              channge profile
            </label>
            <input
            ...
            <button
              type='submit'
              className={` min-w-20 p-2 mt-1 uppercase text-sm font-semibold bg-gray-200 border rounded-full border-primary-100 hover:border-primary-200 hover:bg-primary-100 hover:text-white ${
