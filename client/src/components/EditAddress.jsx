...
const EditAddress = ({ onCloseModel,addressData }) => {
  ...
  const handleAddressSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await addressApi.updateAddress(addressData?._id,address)
  ...
  return (
    <section className='bg-black bg-opacity-70 fixed top-0 bottom-0 left-0 right-0 z-50'>
      <div className='bg-white p-4 w-full max-w-lg mx-auto rounded mt-28 sm:mt-24 max-h-[75vh] sm:max-h-[75vh] overflow-hidden overflow-y-scroll customscrollbar relative '>
        <div className=''>
          <button
        ...
        <h2 className='text-base sm:text-lg font-medium tracking-widest'>Edit Address</h2>
        <div className='p-2'>
